...
class CompaniesController extends Controller
{
    ...
    public function index()
    {
        $companies = Company::join('cities', 'cities.id', '=', 'companies.city_id')
						->select('companies.token_id', 'companies.name', 'companies.description', 'cities.name AS city_name', 'companies.email', 'companies.premium')
						->get();
    ...
    public function destroy($token_id)
    {
		...
		if($jobapplications->isNotEmpty() && $jobs->isNotEmpty()) {
