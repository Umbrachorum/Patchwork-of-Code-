...
/*** Admin routes ***/
	...
	/*Routes cities */
	Route::get('/cities/paginate', [CitiesController::class, 'paginatedIndex']);
	...
	/*Routes child_fields */
	Route::get('/child_fields/paginate', [ChildFieldsController::class, 'paginatedIndex']);
	...
	Route::get('/parent_fields/paginate', [ParentFieldsController::class, 'paginatedIndex']);
    ...
    Route::put('/user/admin/{id}', [UserController::class, 'update']);
    Route::delete('/user/admin/{id}', [UserController::class, 'destroy']);

	/* Routes de Companies */
	Route::get('/companies', [CompaniesController::class, 'index']);
	Route::get('/companies/paginate', [CompaniesController::class, 'paginatedIndex']);
    Route::put('/company/admin/{id}', [CompaniesController::class, 'update']);
    Route::delete('/company/admin/{id}', [CompaniesController::class, 'destroy']);

	/*Routes de Jobs*/
	Route::get('/jobs/paginate', [JobsController::class, 'paginatedBoard']);
    Route::put('/job/admin/{id}', [JobsController::class, 'update']);
    Route::delete('/job/admin/{id}', [JobsController::class, 'destroy']);
