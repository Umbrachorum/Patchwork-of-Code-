	...
	let htmlModal = `<div id="modal${i}" class="modal modal-fixed-footer">
		<div class="modal-content">
			<form class="col s12">
				...
				<div class="row">
					<div class="input-field col s12">
					<textarea id="textarea${i}" class="materialize-textarea" maxlength="255" required></textarea>
...
function returnRegisteredModal(i) {
	let htmlRegisteredModal = `<div id="modal${i}" class="modal modal-fixed-footer">
		<div class="modal-content">
			<form class="col s12">
				<h4>Send your CV and motivation letter</h4>
				<div class="row">
...
async function appendModal(i) {
	...
	if(window.localStorage.getItem('user') !== undefined && window.localStorage.getItem('user') !== null) {
		document.querySelector("main").innerHTML += returnRegisteredModal(i);
	} else {
