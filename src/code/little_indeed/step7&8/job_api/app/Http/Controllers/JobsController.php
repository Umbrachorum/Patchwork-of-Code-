...
class JobsController extends Controller
{
    ...
    public function index()
    {
        ...
        $result = Job::select('jobs.token_id', 'jobs.company_id', 'jobs.id', 'jobs.title', 'jobs.description', 'jobs.worktime', 'jobs.salary', 
		'cities.name AS city_name', 'jobs.city_id',
		'parent_fields.name AS parent_field_name', 'jobs.parent_fields_id',
		'child_fields.name AS child_field_name', 'jobs.child_fields_id',
		'companies.name AS company_name', 'jobs.company_id')
	...
	public function paginatedBoard() {
		$result = Job::select('jobs.token_id', 'jobs.company_id', 'jobs.id', 'jobs.title', 'jobs.description', 'jobs.worktime', 'jobs.salary', 
		'cities.name AS city_name', 'jobs.city_id',
		'parent_fields.name AS parent_field_name', 'jobs.parent_fields_id',
		'child_fields.name AS child_field_name', 'jobs.child_fields_id',
