...
async function initAddButton(cities, parent_fields, child_fields, companies) {
	...
	document.querySelector(`div${modal_id} div.modal-content`).outerHTML = document.querySelector(`div${modal_id} div.modal-content`).outerHTML;
